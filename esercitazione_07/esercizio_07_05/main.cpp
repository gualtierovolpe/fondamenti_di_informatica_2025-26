...
// Ritorna 1 se l'inserimento e' riuscito, 0 altrimenti
...
// const significa che s (passato per riferimento) non verra' modificato dalla funzione
// Passiamo s per riferimento per evitare il passaggio per valore che implica
// la copia di TUTTA la struttura dati, che puo' essere uno spreco di tempo (e memoria)!
